...
class ChordNode(chord_pb2_grpc.chordRPCServicer):
    def __init__(self,id,port=80054,existing_ip=None) -> None:
        super().__init__()
    ...
    def get_data(self, request, context):
        return self.dict2proto(self.data)
    ...
    def init_data(self):
        successStub = self.get_stub(self.successor.ip)
        data = successStub.get_data(Empty()).data
    ...
    def rm_data(self):
        successStub = self.get_stub(self.successor.ip)
        successStub.set_data(self.dict2proto(self.data))
        self.data ={}
