...
def run():
    ...
    client4 = Client("127.0.0.1:50051")
...
def run1():
    ...
    client1.add("key1", "value1");print(client1.hash_key('key1'))
    client2.add("key2", "value2");print(client1.hash_key('key2'))
    client3.add("key3", "value3");print(client1.hash_key('key3'))
    client3.add("key4",' aa');print(client1.hash_key('key4'))
    print(client1.get_data());print(client2.get_data());print(client3.get_data())
    
    client3.update('key4','value4')
    client3.leave()
    
    print(client1.get("key1"));print(client1.get("key2"));print(client1.get("key4"))  
    
    client1.delete("key1")
    print(client1.get_data());print(client2.get_data())
